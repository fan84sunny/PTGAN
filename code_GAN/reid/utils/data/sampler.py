...
import numpy as np
import torch
from torch.utils.data.sampler import (Sampler, SequentialSampler, RandomSampler, SubsetRandomSampler,
...
class RandomPairSampler(Sampler):
    ...
    def __iter__(self):
        ...
        for i in indices:
            ...
            _, pid, _, _, _, _ = self.data_source[anchor_index]
            # positive sample
