...
class VERI(BaseImageDataset):
    ...
    dataset_dir = "veri_pose"
    def __init__(self, root='../AIC21', verbose=True, crop_test=False, **kwargs):
        """
        VeRi-776
        Reference:
        ...
        #  origin VeRi doesnt have train_track  #
    ...
    def _process_dir(self, dir_path, relabel=False, if_track=False):
        ...
        dataset = []
        ## becuase VeRi doesn't have track path ##
    ...
    def _process_dir_test(self, dir_path, relabel=False, query=True):
        ...
        for element in range(len(info)):
            ...
            dataset.append((osp.join(dir_path, image_name), pid, camid,trackid))
            if self.crop_test:
                dataset.append((osp.join(crop_dir, image_name), pid, camid,trackid))
        return dataset
...
if __name__ == '__main__':
    veri = VERI(root='/home/ANYCOLOR2434/AICITY2021_Track2_DMT/AIC21')
